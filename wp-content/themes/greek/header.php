...
<div class="wrapper <?php if($greek_options['page_style']=='box'){echo 'box-layout';}?>">
								...
								<div class="top-info">
									<?php
										if(is_user_logged_in()) {
											echo sprintf(esc_html__('Добро пожаловать, %s', 'greek'), wp_get_current_user()->display_name);
										} else {
											esc_html_e('Добро пожаловать!', 'greek');
										}
									?>
								</div>
							</div>
						...
						<?php if(!empty($greek_options['logo_main']['url'])){ ?>
							<div class="logo">
								<a href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home">
									<img src="<?php echo esc_url($greek_options['logo_main']['url']); ?>" alt="" />
								</a>
							</div>
						<?php } elseif(!empty($greek_options['logo_text'])) {?>
